...
//
// #pragma hmppcg cpiparam __arg0 INOUT a%hmpp_codelet__runBicg: (1, 0)
// #pragma hmppcg cpiparam __arg1 INOUT p%hmpp_codelet__runBicg: (1, 1)
// #pragma hmppcg cpiparam __arg2 INOUT q%hmpp_codelet__runBicg: (1, 2)
// #pragma hmppcg cpiparam __arg3 INOUT r%hmpp_codelet__runBicg: (1, 3)
// #pragma hmppcg cpiparam __arg4 INOUT s%hmpp_codelet__runBicg: (1, 4)
// 
// #pragma hmppcg cpicall hmpp_codelet__runBicg(__arg0, __arg1, __arg2, __arg3, __arg4): 1
// 
// 
// /* begin of extracted source code for directive set "bicg" */
// 
// 
// # 29 "bicg.c"
...
// 
// # 34 "bicg.c"
// void hmpp_codelet__runBicg(DATA_TYPE a[4096][4096], DATA_TYPE p[4096], DATA_TYPE q[4096], DATA_TYPE r[4096], DATA_TYPE s[4096])
// {
//   int  i, j, k, l;
// 
...
// 
// 
// /* end of extracted source code for directive set "bicg" */
// 
// 
//
...
__global__ void hmpp_codelet__runBicg_loop0_(  float * HMPPCG_RESTRICT s)
{
  int32_t i_1;
...
template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__runBicg_loop1_(  float * HMPPCG_RESTRICT a, float * HMPPCG_RESTRICT r, float * HMPPCG_RESTRICT s)
{
  int32_t j_3;
  int32_t outer_j_2;
  j_3 = (blockDimX__ * blockIdx.x  +  threadIdx.x);
  outer_j_2 = (blockDimY__ * blockIdx.y  +  threadIdx.y);
  bool __hmppcg_guard = (!((j_3 <= 1) & (outer_j_2 <= 2047)));
  if(__hmppcg_guard) { goto __hmppcg_label3; };
  {
    int32_t __hmppcg_end, outer_i_2;
    for (outer_i_2 = 0, __hmppcg_end = 2047; outer_i_2 <= __hmppcg_end; outer_i_2 += 1)
    {
      {
        int32_t __hmppcg_end, i_4;
        for (i_4 = 0, __hmppcg_end = 1; i_4 <= __hmppcg_end; i_4 += 1)
        {
          s[j_3 + ((int32_t) (outer_j_2 * 2))] = (s[j_3 + ((int32_t) (outer_j_2 * 2))]) + ((r[i_4 + ((int32_t) (outer_i_2 * 2))]) * (a[((i_4 + ((int32_t) (outer_i_2 * 2))) * 4096) + (j_3 + ((int32_t) (outer_j_2 * 2)))]));
        } 
      }
    } 
  }
...
template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__runBicg_loop2_(  float * HMPPCG_RESTRICT a, float * HMPPCG_RESTRICT p, float * HMPPCG_RESTRICT q)
{
  int32_t i_5;
  int32_t outer_i_4;
  i_5 = (blockDimX__ * blockIdx.x  +  threadIdx.x);
  outer_i_4 = (blockDimY__ * blockIdx.y  +  threadIdx.y);
  bool __hmppcg_guard = (!((i_5 <= 1) & (outer_i_4 <= 2047)));
  if(__hmppcg_guard) { goto __hmppcg_label5; };
  q[i_5 + ((int32_t) (outer_i_4 * 2))] = 0;
  {
    int32_t __hmppcg_end, outer_j_4;
    for (outer_j_4 = 0, __hmppcg_end = 2047; outer_j_4 <= __hmppcg_end; outer_j_4 += 1)
    {
      {
        int32_t __hmppcg_end, j_4;
        for (j_4 = 0, __hmppcg_end = 1; j_4 <= __hmppcg_end; j_4 += 1)
        {
          q[i_5 + ((int32_t) (outer_i_4 * 2))] = (q[i_5 + ((int32_t) (outer_i_4 * 2))]) + ((a[((i_5 + ((int32_t) (outer_i_4 * 2))) * 4096) + (j_4 + ((int32_t) (outer_j_4 * 2)))]) * (p[j_4 + ((int32_t) (outer_j_4 * 2))]));
        } 
      }
    } 
  }
...
void hmpp_codelet__runBicg(  int &hmppcg_status_, void * __h, const cudaDeviceProp &devProp, cudaStream_t kernel_stream, cudaEvent_t kernel_event, Data<float,DefaultPolicy> & a, Data<float,DefaultPolicy> & p, Data<float,DefaultPolicy> & q, Data<float,DefaultPolicy> & r, Data<float,DefaultPolicy> & s)

{
  ...
  #if CUDA_VERSION >= 3020
    s.makeStreamWait(kernel_stream);
  #else
    if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
  #endif
    dim3 dim_block(blockDimX__, blockDimY__);
    hmpp_codelet__runBicg_loop0_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(s.getDeviceAddr());
  ...
  if(1LL)
  {
    ...
    r.makeStreamWait(kernel_stream);
    s.makeStreamWait(kernel_stream);
  #else
    if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
  #endif
    dim3 dim_block(blockDimX__, blockDimY__);
    hmpp_codelet__runBicg_loop1_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(a.getDeviceAddr(), r.getDeviceAddr(), s.getDeviceAddr());
    if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
  #if CUDA_VERSION >= 3020
    if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
    a.waitOnEvent(kernel_event);
    r.waitOnEvent(kernel_event);
    s.waitOnEvent(kernel_event);
  #else
    if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
  #endif
  ...
  #if CUDA_VERSION >= 3020
    a.makeStreamWait(kernel_stream);
    p.makeStreamWait(kernel_stream);
    q.makeStreamWait(kernel_stream);
  #else
    if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
  #endif
    dim3 dim_block(blockDimX__, blockDimY__);
    hmpp_codelet__runBicg_loop2_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(a.getDeviceAddr(), p.getDeviceAddr(), q.getDeviceAddr());
    if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
  #if CUDA_VERSION >= 3020
    if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
    a.waitOnEvent(kernel_event);
    p.waitOnEvent(kernel_event);
    q.waitOnEvent(kernel_event);
  #else
    if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
  #endif
...
HMPP_API int hmpp_start(hmpp_handle_t * __h, int __id, int __async)
{
  int status = 0;
  switch(__id) { 
    case 1: // hmpp_codelet__runBicg(__arg0,__arg1,__arg2,__arg3,__arg4)
      hmpp_codelet__runBicg(status, __h, __h->devProp, __h->kernel_stream, __h->kernel_event,   (*__h->__arg0), (*__h->__arg1), (*__h->__arg2), (*__h->__arg3), (*__h->__arg4));
      return status;
  }
  return -1;
}
