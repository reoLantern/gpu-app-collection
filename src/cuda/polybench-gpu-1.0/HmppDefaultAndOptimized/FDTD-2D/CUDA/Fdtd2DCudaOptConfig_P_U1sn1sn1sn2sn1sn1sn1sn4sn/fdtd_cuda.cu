...
__global__ void hmpp_codelet__runFdtd_loop0_(  int32_t t_11, float * HMPPCG_RESTRICT ey, float * HMPPCG_RESTRICT fict)
{
  int32_t j_1;
...
template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__runFdtd_loop1_(  float * HMPPCG_RESTRICT ey, float * HMPPCG_RESTRICT hz)
{
  int32_t j_2;
  int32_t i_1;
  j_2 = (blockDimX__ * blockIdx.x  +  threadIdx.x);
  i_1 = (blockDimY__ * blockIdx.y  +  threadIdx.y);
  bool __hmppcg_guard = (!((j_2 <= 1023) & (i_1 <= 2046)));
  if(__hmppcg_guard) { goto __hmppcg_label3; };
  ey[((i_1 + 1) * 2048) + j_2] = (ey[((i_1 + 1) * 2048) + j_2]) - ((double) 5.000000000000000E-01 * ((hz[((i_1 + 1) * 2048) + j_2]) - (hz[(i_1 * 2048) + j_2])));
  ey[((i_1 + 1) * 2048) + (j_2 + 1024)] = (ey[((i_1 + 1) * 2048) + (j_2 + 1024)]) - ((double) 5.000000000000000E-01 * ((hz[((i_1 + 1) * 2048) + (j_2 + 1024)]) - (hz[(i_1 * 2048) + (j_2 + 1024)])));
  __hmppcg_label3:;
} 

template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__runFdtd_loop2_(  float * HMPPCG_RESTRICT ex, float * HMPPCG_RESTRICT hz)
{
  int32_t j_3;
  int32_t i_2;
  j_3 = (blockDimX__ * blockIdx.x  +  threadIdx.x);
  i_2 = (blockDimY__ * blockIdx.y  +  threadIdx.y);
  bool __hmppcg_guard = (!((j_3 <= 2046) & (i_2 <= 2047)));
  if(__hmppcg_guard) { goto __hmppcg_label5; };
  ex[(i_2 * 2049) + (j_3 + 1)] = (ex[(i_2 * 2049) + (j_3 + 1)]) - ((double) 5.000000000000000E-01 * ((hz[(i_2 * 2048) + (j_3 + 1)]) - (hz[(i_2 * 2048) + j_3])));
  __hmppcg_label5:;
} 

template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__runFdtd_loop3_(  float * HMPPCG_RESTRICT ex, float * HMPPCG_RESTRICT ey, float * HMPPCG_RESTRICT hz)
{
  int32_t j_4;
  int32_t i_3;
  j_4 = (blockDimX__ * blockIdx.x  +  threadIdx.x);
  i_3 = (blockDimY__ * blockIdx.y  +  threadIdx.y);
  bool __hmppcg_guard = (!((j_4 <= 511) & (i_3 <= 2047)));
  if(__hmppcg_guard) { goto __hmppcg_label7; };
  hz[(i_3 * 2048) + j_4] = (hz[(i_3 * 2048) + j_4]) - ((double) 7.000000000000000E-01 * ((((ex[(i_3 * 2049) + (j_4 + 1)]) - (ex[(i_3 * 2049) + j_4])) + (ey[((i_3 + 1) * 2048) + j_4])) - (ey[(i_3 * 2048) + j_4])));
  hz[(i_3 * 2048) + (j_4 + 512)] = (hz[(i_3 * 2048) + (j_4 + 512)]) - ((double) 7.000000000000000E-01 * ((((ex[(i_3 * 2049) + (j_4 + 513)]) - (ex[(i_3 * 2049) + (j_4 + 512)])) + (ey[((i_3 + 1) * 2048) + (j_4 + 512)])) - (ey[(i_3 * 2048) + (j_4 + 512)])));
  hz[(i_3 * 2048) + (j_4 + 1024)] = (hz[(i_3 * 2048) + (j_4 + 1024)]) - ((double) 7.000000000000000E-01 * ((((ex[(i_3 * 2049) + (j_4 + 1025)]) - (ex[(i_3 * 2049) + (j_4 + 1024)])) + (ey[((i_3 + 1) * 2048) + (j_4 + 1024)])) - (ey[(i_3 * 2048) + (j_4 + 1024)])));
  hz[(i_3 * 2048) + (j_4 + 1536)] = (hz[(i_3 * 2048) + (j_4 + 1536)]) - ((double) 7.000000000000000E-01 * ((((ex[(i_3 * 2049) + (j_4 + 1537)]) - (ex[(i_3 * 2049) + (j_4 + 1536)])) + (ey[((i_3 + 1) * 2048) + (j_4 + 1536)])) - (ey[(i_3 * 2048) + (j_4 + 1536)])));
  __hmppcg_label7:;
} 

void hmpp_codelet__runFdtd(  int &hmppcg_status_, void * __h, const cudaDeviceProp &devProp, cudaStream_t kernel_stream, cudaEvent_t kernel_event, Data<float,DefaultPolicy> & fict, Data<float,DefaultPolicy> & ex, Data<float,DefaultPolicy> & ey, Data<float,DefaultPolicy> & hz)
...
{
  {
    ...
    for (t_1 = 0, __hmppcg_end = 499; t_1 <= __hmppcg_end; t_1 += 1)
    {
      if(1LL)
      {
      ...
      #if CUDA_VERSION >= 3020
        ey.makeStreamWait(kernel_stream);
        fict.makeStreamWait(kernel_stream);
      #else
        if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
      #endif
        dim3 dim_block(blockDimX__, blockDimY__);
        hmpp_codelet__runFdtd_loop0_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(t_1, ey.getDeviceAddr(), fict.getDeviceAddr());
        ...
        ey.waitOnEvent(kernel_event);
        fict.waitOnEvent(kernel_event);
      #else
        if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
      #endif
      ...
      #if CUDA_VERSION >= 3020
        ey.makeStreamWait(kernel_stream);
        hz.makeStreamWait(kernel_stream);
      #else
        if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
      #endif
        dim3 dim_block(blockDimX__, blockDimY__);
        hmpp_codelet__runFdtd_loop1_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(ey.getDeviceAddr(), hz.getDeviceAddr());
        if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
      #if CUDA_VERSION >= 3020
        if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
        ey.waitOnEvent(kernel_event);
        hz.waitOnEvent(kernel_event);
      #else
        if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
      #endif
      ...
      if(1LL)
      {
        ...
        HMPP_CHECK_BLOCK_BOUNDARY(blockDimX__*blockDimY__);
      #if CUDA_VERSION >= 3020
        ex.makeStreamWait(kernel_stream);
        hz.makeStreamWait(kernel_stream);
      #else
        if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
      #endif
        dim3 dim_block(blockDimX__, blockDimY__);
        hmpp_codelet__runFdtd_loop2_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(ex.getDeviceAddr(), hz.getDeviceAddr());
        if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
      #if CUDA_VERSION >= 3020
        if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
        ex.waitOnEvent(kernel_event);
        hz.waitOnEvent(kernel_event);
      #else
        if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
      #endif
      ...
      #endif
        dim3 dim_block(blockDimX__, blockDimY__);
        hmpp_codelet__runFdtd_loop3_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(ex.getDeviceAddr(), ey.getDeviceAddr(), hz.getDeviceAddr());
        if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
      #if CUDA_VERSION >= 3020
        if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
        ex.waitOnEvent(kernel_event);
...
HMPP_API int hmpp_start(hmpp_handle_t * __h, int __id, int __async)
{
  ...
  switch(__id) { 
    case 1: // hmpp_codelet__runFdtd(__arg0,__arg1,__arg2,__arg3)
      hmpp_codelet__runFdtd(status, __h, __h->devProp, __h->kernel_stream, __h->kernel_event,   (*__h->__arg0), (*__h->__arg1), (*__h->__arg2), (*__h->__arg3));
      return status;
  }
  return -1;
}
