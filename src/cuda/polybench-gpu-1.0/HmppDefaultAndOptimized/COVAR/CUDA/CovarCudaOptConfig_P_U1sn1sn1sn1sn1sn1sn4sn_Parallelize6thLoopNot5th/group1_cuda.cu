...
//
// #pragma hmppcg cpiparam __arg0 INOUT pmean%hmpp_codelet__covarLoopa: (1, 0) pmean%hmpp_codelet__covarLoopb: (2, 1)
// #pragma hmppcg cpiparam __arg1 INOUT pdata%hmpp_codelet__covarLoopa: (1, 1) pdata%hmpp_codelet__covarLoopb: (2, 0) pdata%hmpp_codelet__covarLoopc: (3, 1)
// #pragma hmppcg cpiparam __arg2 IN pfloat_n%hmpp_codelet__covarLoopa: (1, 2)
// #pragma hmppcg cpiparam __arg3 INOUT psymmat%hmpp_codelet__covarLoopc: (3, 0)
// 
// #pragma hmppcg cpicall hmpp_codelet__covarLoopa(__arg0, __arg1, __arg2): 1
// #pragma hmppcg cpicall hmpp_codelet__covarLoopb(__arg1, __arg0): 2
// #pragma hmppcg cpicall hmpp_codelet__covarLoopc(__arg3, __arg1): 3
// 
// 
...
// 
// # 39 "covar.c"
// void hmpp_codelet__covarLoopa(DATA_TYPE pmean[2048 + 1], DATA_TYPE pdata[2048 + 1][2048 + 1], DATA_TYPE pfloat_n)
// {
//   int  i, j, j1, j2;
// 
// 
...
// 
// # 62 "covar.c"
// void hmpp_codelet__covarLoopb(DATA_TYPE pdata[2048 + 1][2048 + 1], DATA_TYPE pmean[2048 + 1])
// {
//   int  i, j;
// 
// 
...
// 
// # 81 "covar.c"
// void hmpp_codelet__covarLoopc(DATA_TYPE psymmat[2048 + 1][2048 + 1], DATA_TYPE pdata[2048 + 1][2048 + 1])
// {
//   int  i, j1, j2;
// 
// 
...
__global__ void hmpp_codelet__covarLoopa_loop0_(  float * HMPPCG_RESTRICT pdata, float * HMPPCG_RESTRICT pmean)
{
  ...
  pmean[j_2 + 1] = (double) 0.000000000000000E+00;
  {
    int32_t __hmppcg_end, i_3;
    for (i_3 = 0, __hmppcg_end = 2047; i_3 <= __hmppcg_end; i_3 += 1)
    {
      pmean[j_2 + 1] = (pmean[j_2 + 1]) + (pdata[((i_3 + 1) * 2049) + (j_2 + 1)]);
    } 
  }
  pmean[j_2 + 1] = (pmean[j_2 + 1]) / pfloat_n;
  __hmppcg_label1:;
} 

void hmpp_codelet__covarLoopa(  int &hmppcg_status_, void * __h, const cudaDeviceProp &devProp, cudaStream_t kernel_stream, cudaEvent_t kernel_event, Data<float,DefaultPolicy> & pmean, Data<float,DefaultPolicy> & pdata, Data<float,ConstantPolicy> & pfloat_n)
...
__global__ void hmpp_codelet__covarLoopb_loop0_(  float * HMPPCG_RESTRICT pdata_21, float * HMPPCG_RESTRICT pmean_11)
{
  int32_t j_3;
  int32_t i_4;
  j_3 = (blockDimX__ * blockIdx.x  +  threadIdx.x);
  i_4 = (blockDimY__ * blockIdx.y  +  threadIdx.y);
  bool __hmppcg_guard = (!((j_3 <= 2047) & (i_4 <= 2047)));
  if(__hmppcg_guard) { goto __hmppcg_label3; };
  pdata_21[((i_4 + 1) * 2049) + (j_3 + 1)] = (pdata_21[((i_4 + 1) * 2049) + (j_3 + 1)]) - (pmean_11[j_3 + 1]);
  __hmppcg_label3:;
} 

void hmpp_codelet__covarLoopb(  int &hmppcg_status_, void * __h, const cudaDeviceProp &devProp, cudaStream_t kernel_stream, cudaEvent_t kernel_event, Data<float,DefaultPolicy> & pdata_2, Data<float,DefaultPolicy> & pmean_1)
...
template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__covarLoopc_loop0_(  int32_t j1_21, float * HMPPCG_RESTRICT pdata_11, float * HMPPCG_RESTRICT psymmat)
{
  int32_t j2_2;
  j2_2 = (blockDimX__ * blockDimY__ * blockIdx.x  +  threadIdx.y * blockDimX__  +  threadIdx.x);
  bool __hmppcg_guard = (!(j2_2 <= (2047 - j1_21)));
  if(__hmppcg_guard) { goto __hmppcg_label5; };
  psymmat[((j1_21 + 1) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))] = (double) 0.000000000000000E+00;
  {
    int32_t __hmppcg_end, i_5;
    for (i_5 = 0, __hmppcg_end = 511; i_5 <= __hmppcg_end; i_5 += 1)
    {
      psymmat[((j1_21 + 1) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))] = (psymmat[((j1_21 + 1) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))]) + ((pdata_11[((i_5 + 1) * 2049) + (j1_21 + 1)]) * (pdata_11[((i_5 + 1) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))]));
      psymmat[((j1_21 + 1) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))] = (psymmat[((j1_21 + 1) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))]) + ((pdata_11[((i_5 + 513) * 2049) + (j1_21 + 1)]) * (pdata_11[((i_5 + 513) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))]));
      psymmat[((j1_21 + 1) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))] = (psymmat[((j1_21 + 1) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))]) + ((pdata_11[((i_5 + 1025) * 2049) + (j1_21 + 1)]) * (pdata_11[((i_5 + 1025) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))]));
      psymmat[((j1_21 + 1) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))] = (psymmat[((j1_21 + 1) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))]) + ((pdata_11[((i_5 + 1537) * 2049) + (j1_21 + 1)]) * (pdata_11[((i_5 + 1537) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))]));
    } 
  }
  psymmat[((j2_2 + ((int32_t) (j1_21 + 1))) * 2049) + (j1_21 + 1)] = psymmat[((j1_21 + 1) * 2049) + (j2_2 + ((int32_t) (j1_21 + 1)))];
  __hmppcg_label5:;
} 

void hmpp_codelet__covarLoopc(  int &hmppcg_status_, void * __h, const cudaDeviceProp &devProp, cudaStream_t kernel_stream, cudaEvent_t kernel_event, Data<float,DefaultPolicy> & psymmat, Data<float,DefaultPolicy> & pdata_1)

{
  {
    int32_t __hmppcg_end, j1_2;
    for (j1_2 = 0, __hmppcg_end = 2047; j1_2 <= __hmppcg_end; j1_2 += 1)
    {
      Data<int64_t,DefaultPolicy> tmp_1("tmp_1", LAZY);
      tmp_1.allocate(1,1);
      tmp_1 = 2047 - j1_2;
      if(tmp_1 >= 0LL)
      {
        unsigned int gridDimX__ = (tmp_1 / 256LL) + 1LL;
        HMPP_CHECK_GRID_BOUNDARY(gridDimX__);
        unsigned int gridDimY__ = 1LL;
        HMPP_CHECK_GRID_BOUNDARY(gridDimY__);
        dim3 dim_grid(gridDimX__, gridDimY__);
      ...
      #endif
        dim3 dim_block(blockDimX__, blockDimY__);
        hmpp_codelet__covarLoopc_loop0_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(j1_2, pdata_1.getDeviceAddr(), psymmat.getDeviceAddr());
        if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
      #if CUDA_VERSION >= 3020
        if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
...
typedef struct hmpp_handle_struct
{
  ...
  Data<float,ConstantPolicy> * __arg2;
...
HMPP_API int hmpp_allocateOnHWA(hmpp_handle_t * __h, int major, int minor, const size_t * size, size_t elsize, int dim)
{
  ...
  {
    case HMPPCG_POP_HASH(1,0): // pmean@hmpp_codelet__covarLoopa
    case HMPPCG_POP_HASH(2,1): // pmean@hmpp_codelet__covarLoopb
    {
      __h->__arg0 = new Data<float,DefaultPolicy>("__arg0", DEFAULT);
      return __h->__arg0->allocate2(dim, size);
    }
    case HMPPCG_POP_HASH(1,1): // pdata@hmpp_codelet__covarLoopa
    case HMPPCG_POP_HASH(2,0): // pdata@hmpp_codelet__covarLoopb
    case HMPPCG_POP_HASH(3,1): // pdata@hmpp_codelet__covarLoopc
    {
      __h->__arg1 = new Data<float,DefaultPolicy>("__arg1", DEFAULT);
      return __h->__arg1->allocate2(dim, size);
    }
    case HMPPCG_POP_HASH(1,2): // pfloat_n@hmpp_codelet__covarLoopa
    {
      __h->__arg2 = new Data<float,ConstantPolicy>("__arg2", LAZY);
      __h->__arg2->policy_->setStaticOffset(0);
      return __h->__arg2->allocate(1,1);
    }
    case HMPPCG_POP_HASH(3,0): // psymmat@hmpp_codelet__covarLoopc
    {
...
HMPP_API int hmpp_start(hmpp_handle_t * __h, int __id, int __async)
{
  int status = 0;
  switch(__id) { 
    case 1: // hmpp_codelet__covarLoopa(__arg0,__arg1,__arg2)
      hmpp_codelet__covarLoopa(status, __h, __h->devProp, __h->kernel_stream, __h->kernel_event,   (*__h->__arg0), (*__h->__arg1), (*__h->__arg2));
      return status;
    case 2: // hmpp_codelet__covarLoopb(__arg1,__arg0)
      hmpp_codelet__covarLoopb(status, __h, __h->devProp, __h->kernel_stream, __h->kernel_event,   (*__h->__arg1), (*__h->__arg0));
      return status;
    case 3: // hmpp_codelet__covarLoopc(__arg3,__arg1)
      hmpp_codelet__covarLoopc(status, __h, __h->devProp, __h->kernel_stream, __h->kernel_event,   (*__h->__arg3), (*__h->__arg1));
      return status;
  }
  return -1;
}
