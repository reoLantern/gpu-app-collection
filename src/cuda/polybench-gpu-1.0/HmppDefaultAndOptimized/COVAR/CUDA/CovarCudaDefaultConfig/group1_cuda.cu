...
template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__covarLoopc_loop0_(  float * HMPPCG_RESTRICT pdata_11, float * HMPPCG_RESTRICT psymmat)
{
  int32_t j1_2;
  j1_2 = (blockDimX__ * blockDimY__ * blockIdx.x  +  threadIdx.y * blockDimX__  +  threadIdx.x);
  bool __hmppcg_guard = (!(j1_2 <= 2047));
  if(__hmppcg_guard) { goto __hmppcg_label5; };
  {
    int32_t __hmppcg_end, j2_2;
    for (j2_2 = 0, __hmppcg_end = 2047 - j1_2; j2_2 <= __hmppcg_end; j2_2 += 1)
    {
      psymmat[((j1_2 + 1) * 2049) + (j2_2 + ((int32_t) (j1_2 + 1)))] = (double) 0.000000000000000E+00;
      {
        int32_t __hmppcg_end, i_5;
        for (i_5 = 0, __hmppcg_end = 2047; i_5 <= __hmppcg_end; i_5 += 1)
        {
          psymmat[((j1_2 + 1) * 2049) + (j2_2 + ((int32_t) (j1_2 + 1)))] = (psymmat[((j1_2 + 1) * 2049) + (j2_2 + ((int32_t) (j1_2 + 1)))]) + ((pdata_11[((i_5 + 1) * 2049) + (j1_2 + 1)]) * (pdata_11[((i_5 + 1) * 2049) + (j2_2 + ((int32_t) (j1_2 + 1)))]));
        } 
      }
      psymmat[((j2_2 + ((int32_t) (j1_2 + 1))) * 2049) + (j1_2 + 1)] = psymmat[((j1_2 + 1) * 2049) + (j2_2 + ((int32_t) (j1_2 + 1)))];
    } 
  }
  __hmppcg_label5:;
} 
