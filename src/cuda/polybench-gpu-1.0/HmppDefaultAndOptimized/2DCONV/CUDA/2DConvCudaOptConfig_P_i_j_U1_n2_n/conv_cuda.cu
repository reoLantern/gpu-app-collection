...
//
// #pragma hmppcg cpiparam __arg0 IN A%hmpp_codelet__conv2D: (1, 0)
// #pragma hmppcg cpiparam __arg1 INOUT B%hmpp_codelet__conv2D: (1, 1)
// 
// #pragma hmppcg cpicall hmpp_codelet__conv2D(__arg0, __arg1): 1
// 
// 
...
// 
// # 33 "twodconv.c"
// void hmpp_codelet__conv2D(DATA_TYPE A[4096][4096], DATA_TYPE B[4096][4096])
// {
//   int  i, j, k;
...
__global__ void hmpp_codelet__conv2D_loop0_(  float * HMPPCG_RESTRICT A, float * HMPPCG_RESTRICT B)
{
  float tmp_1;
  float tmp_2;
  float tmp_3;
  ...
  bool __hmppcg_guard = (!((j_1 <= 2046) & (i_1 <= 4093)));
  ...
  tmp_8 = (float) (7);
  tmp_9 = (float) (-8);
  B[((i_1 + 1) * 4096) + ((2 * j_1) + 1)] = ((((((((tmp_1 * (A[(i_1 * 4096) + (2 * j_1)])) + (tmp_2 * (A[((i_1 + 1) * 4096) + (2 * j_1)]))) + (tmp_4 * (A[((i_1 + 2) * 4096) + (2 * j_1)]))) + (tmp_5 * (A[(i_1 * 4096) + ((2 * j_1) + 1)]))) + (tmp_3 * (A[((i_1 + 1) * 4096) + ((2 * j_1) + 1)]))) + (tmp_8 * (A[((i_1 + 2) * 4096) + ((2 * j_1) + 1)]))) + (tmp_9 * (A[(i_1 * 4096) + ((2 * j_1) + 2)]))) + (tmp_6 * (A[((i_1 + 1) * 4096) + ((2 * j_1) + 2)]))) + (tmp_7 * (A[((i_1 + 2) * 4096) + ((2 * j_1) + 2)]));
  B[((i_1 + 1) * 4096) + ((2 * j_1) + 2)] = ((((((((tmp_1 * (A[(i_1 * 4096) + ((2 * j_1) + 1)])) + (tmp_2 * (A[((i_1 + 1) * 4096) + ((2 * j_1) + 1)]))) + (tmp_4 * (A[((i_1 + 2) * 4096) + ((2 * j_1) + 1)]))) + (tmp_5 * (A[(i_1 * 4096) + ((2 * j_1) + 2)]))) + (tmp_3 * (A[((i_1 + 1) * 4096) + ((2 * j_1) + 2)]))) + (tmp_8 * (A[((i_1 + 2) * 4096) + ((2 * j_1) + 2)]))) + (tmp_9 * (A[(i_1 * 4096) + ((2 * j_1) + 3)]))) + (tmp_6 * (A[((i_1 + 1) * 4096) + ((2 * j_1) + 3)]))) + (tmp_7 * (A[((i_1 + 2) * 4096) + ((2 * j_1) + 3)]));
  __hmppcg_label1:;
} 

void hmpp_codelet__conv2D(  int &hmppcg_status_, void * __h, const cudaDeviceProp &devProp, cudaStream_t kernel_stream, cudaEvent_t kernel_event, Data<float,DefaultPolicy> & A, Data<float,DefaultPolicy> & B)

{
  if(1LL)
  {
    ...
    hmpp_codelet__conv2D_loop0_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(A.getDeviceAddr(), B.getDeviceAddr());
...
HMPP_API int hmpp_allocateOnHWA(hmpp_handle_t * __h, int major, int minor, const size_t * size, size_t elsize, int dim)
{
  ...
  {
    case HMPPCG_POP_HASH(1,0): // A@hmpp_codelet__conv2D
    {
      __h->__arg0 = new Data<float,DefaultPolicy>("__arg0", DEFAULT);
      return __h->__arg0->allocate2(dim, size);
    }
    case HMPPCG_POP_HASH(1,1): // B@hmpp_codelet__conv2D
    {
...
HMPP_API int hmpp_start(hmpp_handle_t * __h, int __id, int __async)
{
  int status = 0;
  switch(__id) { 
    case 1: // hmpp_codelet__conv2D(__arg0,__arg1)
      hmpp_codelet__conv2D(status, __h, __h->devProp, __h->kernel_stream, __h->kernel_event,   (*__h->__arg0), (*__h->__arg1));
      return status;
  }
  return -1;
}
