...
__global__ void hmpp_codelet__conv2D_loop0_(  float * HMPPCG_RESTRICT A, float * HMPPCG_RESTRICT B)
{
  ...
  bool __hmppcg_guard = (!((j_1 <= 4093) & (i_1 <= 4093)));
  if(__hmppcg_guard) { goto __hmppcg_label1; };
  B[((i_1 + 1) * 4096) + (j_1 + 1)] = ((((((((((float) (2)) * (A[(i_1 * 4096) + j_1])) + (((float) (-3)) * (A[((i_1 + 1) * 4096) + j_1]))) + (((float) (4)) * (A[((i_1 + 2) * 4096) + j_1]))) + (((float) (5)) * (A[(i_1 * 4096) + (j_1 + 1)]))) + (((float) (6)) * (A[((i_1 + 1) * 4096) + (j_1 + 1)]))) + (((float) (7)) * (A[((i_1 + 2) * 4096) + (j_1 + 1)]))) + (((float) (-8)) * (A[(i_1 * 4096) + (j_1 + 2)]))) + (((float) (-9)) * (A[((i_1 + 1) * 4096) + (j_1 + 2)]))) + (((float) (10)) * (A[((i_1 + 2) * 4096) + (j_1 + 2)]));
  __hmppcg_label1:;
} 
