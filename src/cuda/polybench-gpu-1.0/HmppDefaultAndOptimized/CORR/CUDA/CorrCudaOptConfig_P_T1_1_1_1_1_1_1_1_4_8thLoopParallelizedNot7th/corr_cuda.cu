...
//
// #pragma hmppcg cpiparam __arg0 INOUT pdata%hmpp_codelet__runCorr: (1, 0)
// #pragma hmppcg cpiparam __arg1 INOUT psymmat%hmpp_codelet__runCorr: (1, 1)
// #pragma hmppcg cpiparam __arg2 INOUT pstddev%hmpp_codelet__runCorr: (1, 2)
// #pragma hmppcg cpiparam __arg3 INOUT pmean%hmpp_codelet__runCorr: (1, 3)
// #pragma hmppcg cpiparam __arg4 IN pfloat_n%hmpp_codelet__runCorr: (1, 4)
// #pragma hmppcg cpiparam __arg5 IN peps%hmpp_codelet__runCorr: (1, 5)
// 
// #pragma hmppcg cpicall hmpp_codelet__runCorr(__arg0, __arg1, __arg2, __arg3, __arg4, __arg5): 1
// 
// 
// /* begin of extracted source code for directive set "corr" */
// 
// 
// # 157 "/usr/include/bits/mathcalls.h" 3 4
...
// 
// # 34 "corr.c"
// void hmpp_codelet__runCorr(DATA_TYPE pdata[2048 + 1][2048 + 1], DATA_TYPE psymmat[2048 + 1][2048 + 1], DATA_TYPE pstddev[2048 + 1], DATA_TYPE pmean[2048 + 1], DATA_TYPE pfloat_n, DATA_TYPE peps)
// {
//   int  i, j, j1, j2;
// 
// 
...
// # 63 "<preprocessor>"
// # 92 "corr.c"
//   for (j1 = 1 ; j1 <= 2048 - 1 ; j1++)
//     {
//       psymmat[j1][j1] = 1.0;
// 
//       for (j2 = j1 + 1 ; j2 <= 2048 ; j2++)
//         {
//           psymmat[j1][j2] = 0.0;
// 
...
//         }
//     }
//   psymmat[2048][2048] = 1.0;
// }
// 
// 
// /* end of extracted source code for directive set "corr" */
// 
// 
//
...
#define HMPP_CONSTMEM_OFFSET 16
...
template <const unsigned int blockDimX__, const unsigned int blockDimY__, const uint16_t pfloat_n__>
__global__ void hmpp_codelet__runCorr_loop0_(  float * HMPPCG_RESTRICT pdata, float * HMPPCG_RESTRICT pmean)
{
  float & pfloat_n = (float &)(*(float *)((char *)hmpp_constmem + pfloat_n__));
  int32_t j_1;
  j_1 = (blockDimX__ * blockDimY__ * blockIdx.x  +  threadIdx.y * blockDimX__  +  threadIdx.x);
  bool __hmppcg_guard = (!(j_1 <= 2047));
  if(__hmppcg_guard) { goto __hmppcg_label1; };
  pmean[j_1 + 1] = (double) 0.000000000000000E+00;
  {
    int32_t __hmppcg_end, i_1;
    for (i_1 = 0, __hmppcg_end = 2047; i_1 <= __hmppcg_end; i_1 += 1)
    {
      pmean[j_1 + 1] = (pmean[j_1 + 1]) + (pdata[((i_1 + 1) * 2049) + (j_1 + 1)]);
    } 
  }
  pmean[j_1 + 1] = (pmean[j_1 + 1]) / pfloat_n;
  __hmppcg_label1:;
} 

template <const unsigned int blockDimX__, const unsigned int blockDimY__, const uint16_t peps__, const uint16_t pfloat_n__>
__global__ void hmpp_codelet__runCorr_loop1_(  float * HMPPCG_RESTRICT pdata, float * HMPPCG_RESTRICT pmean, float * HMPPCG_RESTRICT pstddev)
{
  float & peps = (float &)(*(float *)((char *)hmpp_constmem + peps__));
  float & pfloat_n = (float &)(*(float *)((char *)hmpp_constmem + pfloat_n__));
  int32_t j_2;
  j_2 = (blockDimX__ * blockDimY__ * blockIdx.x  +  threadIdx.y * blockDimX__  +  threadIdx.x);
  bool __hmppcg_guard = (!(j_2 <= 2047));
  if(__hmppcg_guard) { goto __hmppcg_label3; };
  pstddev[j_2 + 1] = (double) 0.000000000000000E+00;
  {
    int32_t __hmppcg_end, i_2;
    for (i_2 = 0, __hmppcg_end = 2047; i_2 <= __hmppcg_end; i_2 += 1)
    {
      float tmp_1;
      tmp_1 = (pdata[((i_2 + 1) * 2049) + (j_2 + 1)]) - (pmean[j_2 + 1]);
      pstddev[j_2 + 1] = (pstddev[j_2 + 1]) + (tmp_1 * tmp_1);
    } 
  }
  pstddev[j_2 + 1] = (pstddev[j_2 + 1]) / pfloat_n;
  pstddev[j_2 + 1] = sqrt((double) (pstddev[j_2 + 1]));
  {
    int32_t lazy_1;
    double res_1;
    lazy_1 = ((pstddev[j_2 + 1]) <= peps) != 0;
    if (lazy_1)
    {
...
template <const unsigned int blockDimX__, const unsigned int blockDimY__, const uint16_t pfloat_n__>
__global__ void hmpp_codelet__runCorr_loop2_(  float * HMPPCG_RESTRICT pdata, float * HMPPCG_RESTRICT pmean, float * HMPPCG_RESTRICT pstddev)
{
  float & pfloat_n = (float &)(*(float *)((char *)hmpp_constmem + pfloat_n__));
  int32_t j_3;
  int32_t i_3;
  ...
  bool __hmppcg_guard = (!((j_3 <= 2047) & (i_3 <= 2047)));
  if(__hmppcg_guard) { goto __hmppcg_label5; };
  pdata[((i_3 + 1) * 2049) + (j_3 + 1)] = (pdata[((i_3 + 1) * 2049) + (j_3 + 1)]) - (pmean[j_3 + 1]);
  pdata[((i_3 + 1) * 2049) + (j_3 + 1)] = (pdata[((i_3 + 1) * 2049) + (j_3 + 1)]) / ((sqrt((double) (pfloat_n))) * (pstddev[j_3 + 1]));
  __hmppcg_label5:;
} 

template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__runCorr_loop3_(  int32_t j1_11, float * HMPPCG_RESTRICT psymmat)
{
  int32_t i_6;
  i_6 = (blockDimX__ * blockDimY__ * blockIdx.x  +  threadIdx.y * blockDimX__  +  threadIdx.x);
  bool __hmppcg_guard = (!(i_6 <= 0LL));
  if(__hmppcg_guard) { goto __hmppcg_label7; };
  psymmat[((j1_11 + 1) * 2049) + (j1_11 + 1)] = (double) 1.000000000000000E+00;
  __hmppcg_label7:;
} 

template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__runCorr_loop4_(  int32_t j1_12, float * HMPPCG_RESTRICT pdata, float * HMPPCG_RESTRICT psymmat)
{
  int32_t j2_1;
  j2_1 = (blockDimX__ * blockDimY__ * blockIdx.x  +  threadIdx.y * blockDimX__  +  threadIdx.x);
  bool __hmppcg_guard = (!(j2_1 <= (2046 - j1_12)));
  if(__hmppcg_guard) { goto __hmppcg_label9; };
  psymmat[((j1_12 + 1) * 2049) + (j2_1 + ((int32_t) (j1_12 + 2)))] = (double) 0.000000000000000E+00;
  {
    int32_t __hmppcg_end, outer_i_2;
    for (outer_i_2 = 0, __hmppcg_end = 511; outer_i_2 <= __hmppcg_end; outer_i_2 += 1)
    {
      {
        int32_t __hmppcg_end, i_5;
        for (i_5 = 0, __hmppcg_end = 3; i_5 <= __hmppcg_end; i_5 += 1)
        {
          psymmat[((j1_12 + 1) * 2049) + (j2_1 + ((int32_t) (j1_12 + 2)))] = (psymmat[((j1_12 + 1) * 2049) + (j2_1 + ((int32_t) (j1_12 + 2)))]) + ((pdata[(((i_5 + ((int32_t) (outer_i_2 * 4))) + 1) * 2049) + (j1_12 + 1)]) * (pdata[(((i_5 + ((int32_t) (outer_i_2 * 4))) + 1) * 2049) + (j2_1 + ((int32_t) (j1_12 + 2)))]));
        } 
      }
    } 
  }
  psymmat[((j2_1 + ((int32_t) (j1_12 + 2))) * 2049) + (j1_12 + 1)] = psymmat[((j1_12 + 1) * 2049) + (j2_1 + ((int32_t) (j1_12 + 2)))];
  __hmppcg_label9:;
} 

template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__runCorr_loop5_(  float * HMPPCG_RESTRICT psymmat)
{
  int32_t i_7;
  i_7 = (blockDimX__ * blockDimY__ * blockIdx.x  +  threadIdx.y * blockDimX__  +  threadIdx.x);
  bool __hmppcg_guard = (!(i_7 <= 0LL));
  if(__hmppcg_guard) { goto __hmppcg_label11; };
  psymmat[4198400LL] = (double) 1.000000000000000E+00;
  __hmppcg_label11:;
} 

void hmpp_codelet__runCorr(  int &hmppcg_status_, void * __h, const cudaDeviceProp &devProp, cudaStream_t kernel_stream, cudaEvent_t kernel_event, Data<float,DefaultPolicy> & pdata, Data<float,DefaultPolicy> & psymmat, Data<float,DefaultPolicy> & pstddev, Data<float,DefaultPolicy> & pmean, Data<float,ConstantPolicy> & pfloat_n, Data<float,ConstantPolicy> & peps)

{
  if(1LL)
  {
    ...
    hmpp_codelet__runCorr_loop0_<blockDimX__, blockDimY__, 0 /* pfloat_n */><<<dim_grid, dim_block, 0LL, kernel_stream>>>(pdata.getDeviceAddr(), pmean.getDeviceAddr());
  ...
  if(1LL)
  {
    ...
    pdata.makeStreamWait(kernel_stream);
    pmean.makeStreamWait(kernel_stream);
    pstddev.makeStreamWait(kernel_stream);
  #else
    if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
  #endif
    dim3 dim_block(blockDimX__, blockDimY__);
    hmpp_codelet__runCorr_loop1_<blockDimX__, blockDimY__, 8 /* peps */, 0 /* pfloat_n */><<<dim_grid, dim_block, 0LL, kernel_stream>>>(pdata.getDeviceAddr(), pmean.getDeviceAddr(), pstddev.getDeviceAddr());
    if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
  #if CUDA_VERSION >= 3020
    if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
    pdata.waitOnEvent(kernel_event);
    pmean.waitOnEvent(kernel_event);
    pstddev.waitOnEvent(kernel_event);
  #else
    if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
  #endif
  ...
  if(1LL)
  {
    unsigned int gridDimX__ = 64LL;
    HMPP_CHECK_GRID_BOUNDARY(gridDimX__);
    unsigned int gridDimY__ = 256LL;
    HMPP_CHECK_GRID_BOUNDARY(gridDimY__);
    dim3 dim_grid(gridDimX__, gridDimY__);
    const unsigned int blockDimX__ = 32LL;
    const unsigned int blockDimY__ = 8LL;
  ...
  #endif
    dim3 dim_block(blockDimX__, blockDimY__);
    hmpp_codelet__runCorr_loop2_<blockDimX__, blockDimY__, 0 /* pfloat_n */><<<dim_grid, dim_block, 0LL, kernel_stream>>>(pdata.getDeviceAddr(), pmean.getDeviceAddr(), pstddev.getDeviceAddr());
    if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
  #if CUDA_VERSION >= 3020
    if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
    pdata.waitOnEvent(kernel_event);
  ...
  {
    int32_t __hmppcg_end, j1_1;
    for (j1_1 = 0, __hmppcg_end = 2046; j1_1 <= __hmppcg_end; j1_1 += 1)
    {
      Data<int64_t,DefaultPolicy> tmp_2("tmp_2", LAZY);
      tmp_2.allocate(1,1);
      if(1LL)
      {
        unsigned int gridDimX__ = 1LL;
        HMPP_CHECK_GRID_BOUNDARY(gridDimX__);
        unsigned int gridDimY__ = 1LL;
        HMPP_CHECK_GRID_BOUNDARY(gridDimY__);
        dim3 dim_grid(gridDimX__, gridDimY__);
        const unsigned int blockDimX__ = 32LL;
        const unsigned int blockDimY__ = 4LL;
        HMPP_CHECK_BLOCK_BOUNDARY(blockDimX__*blockDimY__);
      #if CUDA_VERSION >= 3020
      ...
      #endif
        dim3 dim_block(blockDimX__, blockDimY__);
        hmpp_codelet__runCorr_loop3_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(j1_1, psymmat.getDeviceAddr());
        if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
      #if CUDA_VERSION >= 3020
        if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
      ...
      if(tmp_2 >= 0LL)
      {
        unsigned int gridDimX__ = (tmp_2 / 256LL) + 1LL;
        HMPP_CHECK_GRID_BOUNDARY(gridDimX__);
        unsigned int gridDimY__ = 1LL;
        HMPP_CHECK_GRID_BOUNDARY(gridDimY__);
        dim3 dim_grid(gridDimX__, gridDimY__);
      ...
      #endif
        dim3 dim_block(blockDimX__, blockDimY__);
        hmpp_codelet__runCorr_loop4_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(j1_1, pdata.getDeviceAddr(), psymmat.getDeviceAddr());
        if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
      #if CUDA_VERSION >= 3020
        if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
        pdata.waitOnEvent(kernel_event);
  ...
  #endif
    dim3 dim_block(blockDimX__, blockDimY__);
    hmpp_codelet__runCorr_loop5_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(psymmat.getDeviceAddr());
    if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
  #if CUDA_VERSION >= 3020
    if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
    psymmat.waitOnEvent(kernel_event);
...
typedef struct hmpp_handle_struct
{
  ...
  Data<float,ConstantPolicy> * __arg4;
  Data<float,ConstantPolicy> * __arg5;
...
HMPP_API int hmpp_allocateOnHWA(hmpp_handle_t * __h, int major, int minor, const size_t * size, size_t elsize, int dim)
{
  ...
  {
    case HMPPCG_POP_HASH(1,0): // pdata@hmpp_codelet__runCorr
    {
      __h->__arg0 = new Data<float,DefaultPolicy>("__arg0", DEFAULT);
      return __h->__arg0->allocate2(dim, size);
    }
    case HMPPCG_POP_HASH(1,1): // psymmat@hmpp_codelet__runCorr
    {
      __h->__arg1 = new Data<float,DefaultPolicy>("__arg1", DEFAULT);
      return __h->__arg1->allocate2(dim, size);
    }
    case HMPPCG_POP_HASH(1,2): // pstddev@hmpp_codelet__runCorr
    {
      __h->__arg2 = new Data<float,DefaultPolicy>("__arg2", DEFAULT);
      return __h->__arg2->allocate2(dim, size);
    }
    case HMPPCG_POP_HASH(1,3): // pmean@hmpp_codelet__runCorr
    {
      __h->__arg3 = new Data<float,DefaultPolicy>("__arg3", DEFAULT);
      return __h->__arg3->allocate2(dim, size);
    }
    case HMPPCG_POP_HASH(1,4): // pfloat_n@hmpp_codelet__runCorr
    {
      __h->__arg4 = new Data<float,ConstantPolicy>("__arg4", LAZY);
      __h->__arg4->policy_->setStaticOffset(0);
      return __h->__arg4->allocate(1,1);
    }
    case HMPPCG_POP_HASH(1,5): // peps@hmpp_codelet__runCorr
    {
      __h->__arg5 = new Data<float,ConstantPolicy>("__arg5", LAZY);
      __h->__arg5->policy_->setStaticOffset(8);
      return __h->__arg5->allocate(1,1);
    }
    default: return -1;
  }
}
...
HMPP_API int hmpp_start(hmpp_handle_t * __h, int __id, int __async)
{
  int status = 0;
  switch(__id) { 
    case 1: // hmpp_codelet__runCorr(__arg0,__arg1,__arg2,__arg3,__arg4,__arg5)
      hmpp_codelet__runCorr(status, __h, __h->devProp, __h->kernel_stream, __h->kernel_event,   (*__h->__arg0), (*__h->__arg1), (*__h->__arg2), (*__h->__arg3), (*__h->__arg4), (*__h->__arg5));
      return status;
  }
  return -1;
}
