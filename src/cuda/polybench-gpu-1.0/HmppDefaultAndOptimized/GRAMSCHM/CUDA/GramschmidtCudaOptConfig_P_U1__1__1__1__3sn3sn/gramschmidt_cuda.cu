...
//
// #pragma hmppcg cpiparam __arg0 INOUT pA%hmpp_codelet__runGramSchmidt: (1, 0)
// #pragma hmppcg cpiparam __arg1 INOUT pR%hmpp_codelet__runGramSchmidt: (1, 1)
// #pragma hmppcg cpiparam __arg2 INOUT pQ%hmpp_codelet__runGramSchmidt: (1, 2)
// 
// #pragma hmppcg cpicall hmpp_codelet__runGramSchmidt(__arg0, __arg1, __arg2): 1
// 
// 
// /* begin of extracted source code for directive set "gramschmidt" */
// 
// 
...
// 
// # 34 "gramschmidt.c"
// void hmpp_codelet__runGramSchmidt(DATA_TYPE pA[2048][2048], DATA_TYPE pR[2048][2048], DATA_TYPE pQ[2048][2048])
// {
//   int  i, j, k;
//   int  m = 2048;
//   int  n = 2048;
...
// 
// 
// /* end of extracted source code for directive set "gramschmidt" */
// 
// 
//
...
__global__ void hmpp_codelet__runGramSchmidt_loop0_(  int32_t k_12, float * HMPPCG_RESTRICT pA, float * HMPPCG_RESTRICT pR)
{
  ...
  priv_priv_pnrm_1 = 0;
  {
    ...
    {
      priv_priv_pnrm_1 = priv_priv_pnrm_1 + ((pA[(i_1 * 2048) + k_12]) * (pA[(i_1 * 2048) + k_12]));
    } 
  }
  pR[(k_12 * 2048) + k_12] = sqrtf(priv_priv_pnrm_1);
  __hmppcg_label1:;
} 

template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__runGramSchmidt_loop1_(  int32_t k_11, float * HMPPCG_RESTRICT pA, float * HMPPCG_RESTRICT pQ, float * HMPPCG_RESTRICT pR)
{
  int32_t i_2;
  i_2 = (blockDimX__ * blockDimY__ * blockIdx.x  +  threadIdx.y * blockDimX__  +  threadIdx.x);
  bool __hmppcg_guard = (!(i_2 <= 2047));
  if(__hmppcg_guard) { goto __hmppcg_label3; };
  pQ[(i_2 * 2048) + k_11] = (pA[(i_2 * 2048) + k_11]) / (pR[(k_11 * 2048) + k_11]);
  __hmppcg_label3:;
} 

template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__runGramSchmidt_loop2_(  int32_t k_13, float * HMPPCG_RESTRICT pA, float * HMPPCG_RESTRICT pQ, float * HMPPCG_RESTRICT pR)
{
  int32_t j_1;
  j_1 = (blockDimX__ * blockDimY__ * blockIdx.x  +  threadIdx.y * blockDimX__  +  threadIdx.x);
  bool __hmppcg_guard = (!(j_1 <= (2046 - k_13)));
  if(__hmppcg_guard) { goto __hmppcg_label5; };
  pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))] = 0;
  {
    int32_t __hmppcg_end, i_3;
    for (i_3 = 0, __hmppcg_end = 683; i_3 <= __hmppcg_end; i_3 += 1)
    {
      if (i_3 <= 681)
      {
        pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))] = (pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]) + ((pQ[(i_3 * 2048) + k_13]) * (pA[(i_3 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]));
        pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))] = (pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]) + ((pQ[((i_3 + 682) * 2048) + k_13]) * (pA[((i_3 + 682) * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]));
        pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))] = (pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]) + ((pQ[((i_3 + 1364) * 2048) + k_13]) * (pA[((i_3 + 1364) * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]));
      } 
      else
      {
        pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))] = (pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]) + ((pQ[((i_3 + 1364) * 2048) + k_13]) * (pA[((i_3 + 1364) * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]));
  ...
  }
  {
    ...
    for (i_4 = 0, __hmppcg_end = 683; i_4 <= __hmppcg_end; i_4 += 1)
    {
      if (i_4 <= 681)
      {
        pA[(i_4 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))] = (pA[(i_4 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]) - ((pQ[(i_4 * 2048) + k_13]) * (pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]));
        pA[((i_4 + 682) * 2048) + (j_1 + ((int32_t) (k_13 + 1)))] = (pA[((i_4 + 682) * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]) - ((pQ[((i_4 + 682) * 2048) + k_13]) * (pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]));
        pA[((i_4 + 1364) * 2048) + (j_1 + ((int32_t) (k_13 + 1)))] = (pA[((i_4 + 1364) * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]) - ((pQ[((i_4 + 1364) * 2048) + k_13]) * (pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]));
      } 
      else
      {
        pA[((i_4 + 1364) * 2048) + (j_1 + ((int32_t) (k_13 + 1)))] = (pA[((i_4 + 1364) * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]) - ((pQ[((i_4 + 1364) * 2048) + k_13]) * (pR[(k_13 * 2048) + (j_1 + ((int32_t) (k_13 + 1)))]));
...
void hmpp_codelet__runGramSchmidt(  int &hmppcg_status_, void * __h, const cudaDeviceProp &devProp, cudaStream_t kernel_stream, cudaEvent_t kernel_event, Data<float,DefaultPolicy> & pA, Data<float,DefaultPolicy> & pR, Data<float,DefaultPolicy> & pQ)

{
  {
    int32_t __hmppcg_end, k_1;
    for (k_1 = 0, __hmppcg_end = 2047; k_1 <= __hmppcg_end; k_1 += 1)
    {
      ...
      if(1LL)
      {
      ...
      #if CUDA_VERSION >= 3020
        pA.makeStreamWait(kernel_stream);
        pR.makeStreamWait(kernel_stream);
      #else
        if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
      #endif
        dim3 dim_block(blockDimX__, blockDimY__);
        hmpp_codelet__runGramSchmidt_loop0_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(k_1, pA.getDeviceAddr(), pR.getDeviceAddr());
        ...
        pA.waitOnEvent(kernel_event);
        pR.waitOnEvent(kernel_event);
      #else
        if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
      #endif
      ...
      #if CUDA_VERSION >= 3020
        pA.makeStreamWait(kernel_stream);
        pQ.makeStreamWait(kernel_stream);
        pR.makeStreamWait(kernel_stream);
      #else
        if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
      #endif
        dim3 dim_block(blockDimX__, blockDimY__);
        hmpp_codelet__runGramSchmidt_loop1_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(k_1, pA.getDeviceAddr(), pQ.getDeviceAddr(), pR.getDeviceAddr());
        if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
      #if CUDA_VERSION >= 3020
        if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
        pA.waitOnEvent(kernel_event);
        pQ.waitOnEvent(kernel_event);
        pR.waitOnEvent(kernel_event);
      #else
        if ((hmppcg_status_ = CHECK_STATUS(cudaDeviceSynchronize()))) return;
      #endif
      ...
      #endif
        dim3 dim_block(blockDimX__, blockDimY__);
        hmpp_codelet__runGramSchmidt_loop2_<blockDimX__, blockDimY__><<<dim_grid, dim_block, 0LL, kernel_stream>>>(k_1, pA.getDeviceAddr(), pQ.getDeviceAddr(), pR.getDeviceAddr());
        if ((hmppcg_status_ = CHECK_STATUS(cudaGetLastError()))) return;
      #if CUDA_VERSION >= 3020
        if((hmppcg_status_ = CHECK_STATUS(cudaEventRecord(kernel_event, kernel_stream)))) return;
        pA.waitOnEvent(kernel_event);
...
HMPP_API int hmpp_start(hmpp_handle_t * __h, int __id, int __async)
{
  int status = 0;
  switch(__id) { 
    case 1: // hmpp_codelet__runGramSchmidt(__arg0,__arg1,__arg2)
      hmpp_codelet__runGramSchmidt(status, __h, __h->devProp, __h->kernel_stream, __h->kernel_event,   (*__h->__arg0), (*__h->__arg1), (*__h->__arg2));
      return status;
  }
  return -1;
}
