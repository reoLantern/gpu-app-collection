...
//
// #pragma hmppcg cpiparam __arg0 IN a%hmpp_codelet__runSyrTwoK: (1, 0)
// #pragma hmppcg cpiparam __arg1 IN b%hmpp_codelet__runSyrTwoK: (1, 1)
// #pragma hmppcg cpiparam __arg2 INOUT c%hmpp_codelet__runSyrTwoK: (1, 2)
// 
// #pragma hmppcg cpicall hmpp_codelet__runSyrTwoK(__arg0, __arg1, __arg2): 1
// 
// 
// /* begin of extracted source code for directive set "syrtwok" */
// 
// 
// # 29 "syr2k.c"
...
// 
// # 34 "syr2k.c"
// void hmpp_codelet__runSyrTwoK(DATA_TYPE a[2048][2048], DATA_TYPE b[2048][2048], DATA_TYPE c[2048][2048])
// {
//   int  i, j, k, n, m;
...
// 
// 
// /* end of extracted source code for directive set "syrtwok" */
// 
// 
//
...
__global__ void hmpp_codelet__runSyrTwoK_loop0_(  float * HMPPCG_RESTRICT c)
{
  int32_t j_1;
  int32_t i_1;
  j_1 = (blockDimX__ * blockIdx.x  +  threadIdx.x);
  i_1 = (blockDimY__ * blockIdx.y  +  threadIdx.y);
  bool __hmppcg_guard = (!((j_1 <= 2047) & (i_1 <= 2047)));
  if(__hmppcg_guard) { goto __hmppcg_label1; };
  c[(i_1 * 2048) + j_1] = (c[(i_1 * 2048) + j_1]) * ((float) (4546));
  __hmppcg_label1:;
} 

template <const unsigned int blockDimX__, const unsigned int blockDimY__>
__global__ void hmpp_codelet__runSyrTwoK_loop1_(  float * HMPPCG_RESTRICT a, float * HMPPCG_RESTRICT b, float * HMPPCG_RESTRICT c)
{
  int32_t j_2;
  int32_t i_2;
  ...
  if(__hmppcg_guard) { goto __hmppcg_label3; };
  {
    ...
    for (k_1 = 0, __hmppcg_end = 681; k_1 <= __hmppcg_end; k_1 += 1)
    {
      float tmp_2;
      tmp_2 = (float) (12435);
      c[(i_2 * 2048) + j_2] = (c[(i_2 * 2048) + j_2]) + ((tmp_2 * (a[(i_2 * 2048) + k_1])) * (b[(j_2 * 2048) + k_1]));
      c[(i_2 * 2048) + j_2] = (c[(i_2 * 2048) + j_2]) + ((tmp_2 * (b[(i_2 * 2048) + k_1])) * (a[(j_2 * 2048) + k_1]));
      c[(i_2 * 2048) + j_2] = (c[(i_2 * 2048) + j_2]) + ((tmp_2 * (a[(i_2 * 2048) + (k_1 + 682)])) * (b[(j_2 * 2048) + (k_1 + 682)]));
      c[(i_2 * 2048) + j_2] = (c[(i_2 * 2048) + j_2]) + ((tmp_2 * (b[(i_2 * 2048) + (k_1 + 682)])) * (a[(j_2 * 2048) + (k_1 + 682)]));
      c[(i_2 * 2048) + j_2] = (c[(i_2 * 2048) + j_2]) + ((tmp_2 * (a[(i_2 * 2048) + (k_1 + 1364)])) * (b[(j_2 * 2048) + (k_1 + 1364)]));
      c[(i_2 * 2048) + j_2] = (c[(i_2 * 2048) + j_2]) + ((tmp_2 * (b[(i_2 * 2048) + (k_1 + 1364)])) * (a[(j_2 * 2048) + (k_1 + 1364)]));
    } 
  }
  {
    int32_t __hmppcg_end, k_2;
    #pragma novector
    for (k_2 = 0LL, __hmppcg_end = 1LL; k_2 <= __hmppcg_end; k_2 += 1LL)
    {
      float tmp_1;
      tmp_1 = (float) (12435);
      c[(i_2 * 2048) + j_2] = (c[(i_2 * 2048) + j_2]) + ((tmp_1 * (a[(i_2 * 2048) + (k_2 + 2046)])) * (b[(j_2 * 2048) + (k_2 + 2046)]));
      c[(i_2 * 2048) + j_2] = (c[(i_2 * 2048) + j_2]) + ((tmp_1 * (b[(i_2 * 2048) + (k_2 + 2046)])) * (a[(j_2 * 2048) + (k_2 + 2046)]));
    } 
  }
  __hmppcg_label3:;
} 

void hmpp_codelet__runSyrTwoK(  int &hmppcg_status_, void * __h, const cudaDeviceProp &devProp, cudaStream_t kernel_stream, cudaEvent_t kernel_event, Data<float,DefaultPolicy> & a, Data<float,DefaultPolicy> & b, Data<float,DefaultPolicy> & c)
...
HMPP_API int hmpp_start(hmpp_handle_t * __h, int __id, int __async)
{
  int status = 0;
  switch(__id) { 
    case 1: // hmpp_codelet__runSyrTwoK(__arg0,__arg1,__arg2)
      hmpp_codelet__runSyrTwoK(status, __h, __h->devProp, __h->kernel_stream, __h->kernel_event,   (*__h->__arg0), (*__h->__arg1), (*__h->__arg2));
      return status;
  }
  return -1;
}
