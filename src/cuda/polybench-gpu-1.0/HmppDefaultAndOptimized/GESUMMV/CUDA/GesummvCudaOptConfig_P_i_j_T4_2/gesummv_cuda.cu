...
__global__ void hmpp_codelet__runGesummv_loop0_(  float * HMPPCG_RESTRICT a, float * HMPPCG_RESTRICT b, float * HMPPCG_RESTRICT tmp1, float * HMPPCG_RESTRICT x1, float * HMPPCG_RESTRICT y1)
{
  int32_t i_2;
  int32_t outer_i_2;
  i_2 = (blockDimX__ * blockIdx.x  +  threadIdx.x);
  outer_i_2 = (blockDimY__ * blockIdx.y  +  threadIdx.y);
  bool __hmppcg_guard = (!((i_2 <= 3) & (outer_i_2 <= 1023)));
  if(__hmppcg_guard) { goto __hmppcg_label1; };
  {
    int32_t __hmppcg_end, outer_j_2;
    for (outer_j_2 = 0, __hmppcg_end = 2047; outer_j_2 <= __hmppcg_end; outer_j_2 += 1)
    {
      {
        int32_t __hmppcg_end, j_2;
        for (j_2 = 0, __hmppcg_end = 1; j_2 <= __hmppcg_end; j_2 += 1)
        {
          if ((j_2 + ((int32_t) (outer_j_2 * 2))) == 0)
          {
            tmp1[i_2 + ((int32_t) (outer_i_2 * 4))] = 0;
            y1[i_2 + ((int32_t) (outer_i_2 * 4))] = 0;
          } 
          tmp1[i_2 + ((int32_t) (outer_i_2 * 4))] = ((a[((i_2 + ((int32_t) (outer_i_2 * 4))) * 4096) + (j_2 + ((int32_t) (outer_j_2 * 2)))]) * (x1[j_2 + ((int32_t) (outer_j_2 * 2))])) + (tmp1[i_2 + ((int32_t) (outer_i_2 * 4))]);
          y1[i_2 + ((int32_t) (outer_i_2 * 4))] = ((b[((i_2 + ((int32_t) (outer_i_2 * 4))) * 4096) + (j_2 + ((int32_t) (outer_j_2 * 2)))]) * (x1[j_2 + ((int32_t) (outer_j_2 * 2))])) + (y1[i_2 + ((int32_t) (outer_i_2 * 4))]);
          if ((j_2 + ((int32_t) (outer_j_2 * 2))) == 4095)
          {
            y1[i_2 + ((int32_t) (outer_i_2 * 4))] = (((float) (43532)) * (tmp1[i_2 + ((int32_t) (outer_i_2 * 4))])) + (((float) (12313)) * (y1[i_2 + ((int32_t) (outer_i_2 * 4))]));
          } 
        } 
      }
    } 
