...
__global__ void hmpp_codelet__conv3D_loop0_(  float * HMPPCG_RESTRICT A, float * HMPPCG_RESTRICT B)
{
  ...
  bool __hmppcg_guard = (!((j_1 <= 253) & (i_1 <= 253)));
  if(__hmppcg_guard) { goto __hmppcg_label1; };
  {
    int32_t __hmppcg_end, k_1;
    for (k_1 = 0, __hmppcg_end = 253; k_1 <= __hmppcg_end; k_1 += 1)
    {
      float tmp_1;
      float tmp_2;
      float tmp_3;
      ...
      tmp_5 = (float) (4);
      tmp_6 = (float) (7);
      B[((((i_1 + 1) * 256) + (j_1 + 1)) * 256) + (k_1 + 1)] = ((((((((((((((tmp_2 * (A[(((i_1 * 256) + j_1) * 256) + k_1])) + (tmp_5 * (A[((((i_1 + 2) * 256) + j_1) * 256) + k_1]))) + (tmp_3 * (A[(((i_1 * 256) + j_1) * 256) + k_1]))) + (tmp_6 * (A[((((i_1 + 2) * 256) + j_1) * 256) + k_1]))) + (tmp_4 * (A[(((i_1 * 256) + j_1) * 256) + k_1]))) + (tmp_1 * (A[((((i_1 + 2) * 256) + j_1) * 256) + k_1]))) + (((float) (-3)) * (A[((((i_1 + 1) * 256) + j_1) * 256) + (k_1 + 1)]))) + (((float) (6)) * (A[((((i_1 + 1) * 256) + (j_1 + 1)) * 256) + (k_1 + 1)]))) + (((float) (-9)) * (A[((((i_1 + 1) * 256) + (j_1 + 2)) * 256) + (k_1 + 1)]))) + (tmp_2 * (A[(((i_1 * 256) + j_1) * 256) + (k_1 + 2)]))) + (tmp_5 * (A[((((i_1 + 2) * 256) + j_1) * 256) + (k_1 + 2)]))) + (tmp_3 * (A[(((i_1 * 256) + (j_1 + 1)) * 256) + (k_1 + 2)]))) + (tmp_6 * (A[((((i_1 + 2) * 256) + (j_1 + 1)) * 256) + (k_1 + 2)]))) + (tmp_4 * (A[(((i_1 * 256) + (j_1 + 2)) * 256) + (k_1 + 2)]))) + (tmp_1 * (A[((((i_1 + 2) * 256) + (j_1 + 2)) * 256) + (k_1 + 2)]));
    } 
  }
  __hmppcg_label1:;
} 

void hmpp_codelet__conv3D(  int &hmppcg_status_, void * __h, const cudaDeviceProp &devProp, cudaStream_t kernel_stream, cudaEvent_t kernel_event, Data<float,DefaultPolicy> & A, Data<float,DefaultPolicy> & B)
